 ...
 <!--INICIO TABLA DE PRODUCTOS
  ...
  <table class="table">
    ...
    <tbody>
      ...
      include('conec.php'); // Conexion a la bd
      $consulta =
        "SELECT producto.codigo, producto.nombre, producto.precio, fabricante.nombre as nombreFabricante
          FROM producto
      ...
      ?>
        <tr>
          ...
          <!-- Boton eliminar-->
          <td><a target="_self" href="acciones/eliminarProducto.php?id=<?php echo $fila["codigo"] ?>" <i class="bi bi-trash3-fill text-danger"></i>Eliminar</td>
        </tr>
        <tr>
        <?php } ?>
    </tbody>
